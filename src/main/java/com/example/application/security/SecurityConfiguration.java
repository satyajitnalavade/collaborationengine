...
public class SecurityConfiguration extends VaadinWebSecurityConfigurerAdapter {
  ...
  public UserDetailsService userDetailsService() {
    UserDetails homer = User.withUsername("satya").password("{noop}satya").roles("USER").build();
    UserDetails marge = User.withUsername("vaishali").password("{noop}vaishali").roles("USER").build();
